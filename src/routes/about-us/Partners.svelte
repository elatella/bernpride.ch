<section id="description" class="root">
	<div class="main-content">
		...
		<p>
			...
			EuroGames Bern 2023 und den Acts auf dem Bundesplatz können Partner*innen (Unternehmen,
			Organisationen und Stiftungen) eingebunden werden. Diese werden sorgfältig ausgewählt. Es
			werden aber nur Partner*innen akzeptiert, welche die Interessen und Ziele der Community
			vertreten und innerhalb ihrer Organisationsstruktur fördern. Es wird darauf geachtet, dass
			keine Unternehmen oder Organisationen Partner*innen des Vereins EuroGames Bern werden, welche
			sich durch eine solche Partnerschaft nur Vorteile im Bereich des Marketings erhoffen.
