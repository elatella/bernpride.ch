<script lang="ts">
	...
	const activities: Activity[] = [
		...
		},
		{
			...
			description:
				'Das EuroGames Village wird am ersten Abend ordentlich zum Tanzen gebracht. Troubas Kater, die Berner Lokalmatadoren, bringen das Münster mit ihren unverkennbaren Liedern in Mundart zum beben. Sei auch du mit dabei!',
			location: 'EuroGames Village'
		},
		{
			day: Day.Wednesday,
		...
		},
		{
			day: Day.Thursday,
			time: '18.00 Uhr',
			title: 'Queer Poetry Slam (mit DJ)',
			description:
				'Poetische queere Texte auf Mundart, Deutsch und Englisch verzaubern das Village während zwei Sets à rund 40 Minuten. Moderation: Kay WIEOIMMER',
			location: 'EuroGames Village'
		},
		{
			day: Day.Thursday,
		...
		},
		{
			day: Day.Thursday,
			time: '22.00 Uhr',
			title: '"Sport With Benefits" - Party',
			description:
		...
		},
		{
			day: Day.Friday,
			time: '22.00 Uhr',
			title: 'Dancing Queer - Show your Medals',
			description:
		...
		},
		{
			day: Day.Saturday,
			time: '18.15 Uhr',
			title: 'Schlusszeremonie EuroGames',
			description:
		...
		},
		{
			day: Day.Saturday,
			time: '18.30 Uhr',
			title: 'Paprika, Ray Belle und Ares',
			description:
